...
<template>
  ...
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    ...
    <div class="h-19.5">
      ...
      <span class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer xl:hidden">
        <i class=" fas fa-times text-slate-400 " sidenav-close></i>
      </span>
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <NuxtLink to="/dashboard" id="menu_btn_dashboard" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" >

            <div id="menu_div_dashboard" class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
              <i class="fas fa-tachometer-alt text-slate-800" id="menu_ico_dashboard"></i>
            </div>
        ...
        <li class="mt-0.5 w-full">
          <NuxtLink to="/prueba" id="menu_btn_test" class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" >

            <div id="menu_div_test" class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
              <i class="fas fa-vials text-slate-800" id="menu_ico_test"></i>
            </div>
